    ...
    <>
      ...
      >
        ...
        <div className="flex items-center justify-between h-16 px-6 bg-slate-50/80 border-b border-slate-200">
          ...
          >
            <div className="w-9 h-9 rounded-xl bg-blue-600 flex items-center justify-center text-orange-300 shadow-sm shadow-blue-600/20 shrink-0">
          ...
          <button
            onClick={onClose}
            className="p-1.5 rounded-lg text-slate-400 hover:text-slate-700 hover:bg-slate-200 lg:hidden cursor-pointer"
        ...
        <div className="p-4 border-t border-slate-200 bg-slate-50/70">
          {onLockApp && (
            <button
              ...
              className="w-full flex items-center justify-center gap-2 px-3 py-2.5 rounded-xl bg-white hover:bg-rose-50 text-slate-700 hover:text-rose-700 text-xs font-semibold transition-colors border border-slate-200 shadow-2xs cursor-pointer"
            >
